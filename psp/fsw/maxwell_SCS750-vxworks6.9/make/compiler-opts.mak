...
#WARNINGS	= -Wall  -ansi
# -ansi is not allowing // comments, and we want to use // comments...
# interestingly, the linux .mak file does not use -ansi, but 
# uses -pedantic -Wstrict-prototypes, which were commented out
WARNINGS	= -Wall
